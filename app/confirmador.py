...
def mensagem_env(env, nome, hora):
    match env:
        ...
        case 'emyconsultorio':
            return (f'Olá, {nome},\n\n'
                    f'Hoje você tem uma consulta agendada com a Dra. Eminy Bezerra às {hora}. \n\n'
                    f'Até breve!')

def is_six_am_brasil():
    agora = get_hora_brasil()
    return agora.hour == 6 and agora.minute == 0 and agora.second == 0
                ...
                try:
                    ...
                    for agendamento in agendamentos:
                        ...
                        if hora_agendada - timedelta(hours=1) <= hora_atual <= hora_agendada:
                            ...
                            # Incorporar aqui a lógica dos status e lembrar de ver como resolver o possível problema
                            # dos múltiplos agendamentos no mesmo dia
